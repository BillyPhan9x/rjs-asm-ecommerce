...
const LiveChat = () => {
  ...
  return (
    <div className="wrapper_chat">
      <div className="chat__messenger" onClick={toggleChat}>
      ...
      {activeChat && (
        <div className="chat__active animate__animated animate__jackInTheBox">
          <div style={{ width: "100%" }}>
            <div className="card card-bordered fix__border-chat">
              <div className="card-header">
                <h4 className="card-title">
                  <strong>Customer Support</strong>
                </h4>
                <Link className="btn btn-xs bg-secondary" to="#">
                  Let's Chat App
                </Link>
              </div>

              <div className="ps-container ps-theme-default ps-active-y fix__scroll">
                {message &&
                  message.map(
                    (value, index) =>
                      value.category === "send" && (
                        <div
                          className="media media__chat media__chat-reverse"
                          key={index}
                        >
              ...
              <div className="publisher bt-1 border-light">
                ...
                <Link className="publisher-btn" to="#" data-abc="true">
